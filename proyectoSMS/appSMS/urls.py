...
urlpatterns = [
    ...
    path('marcar-leido/<int:message_id>/', views.marcar_mensaje_leido, name='marcar_mensaje_leido'),
    path('crear_grupo/', views.create_group, name='crear_grupo'),
    path('grupo_chat/<slug:group_name>/', views.group_chat, name='chat_grupal'),
    path('marcar-leido-grupo/<slug:group_name>/', views.marcar_mensaje_leido_grupo, name='marcar_mensaje_leido_grupo'),
